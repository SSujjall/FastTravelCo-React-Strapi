...
const CompactSearchSection = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-white border border-slate-100 shadow-lg rounded-full">
      <div className="flex flex-row justify-between items-stretch font-semibold gap-4">
        ...
        <div className="flex items-center space-x-2 flex-1">
          ...
          <input
            ...
            className="border-0 rounded p-2 w-full outline-none text-sm"
          />
        </div>

        <div className="hidden lg:block mx-4 h-10 my-auto border-l border-gray-200" />
        ...
        <div className="hidden md:flex items-center space-x-2 flex-1 relative">
          ...
          >
            <span className="text-gray-600 text-sm">{formatDateRange()}</span>
          </div>
        ...
        <div className="flex items-center">
          <Button
            ...
            icon="search"
            className="bg-black text-white hover:bg-slate-600 w-full lg:w-auto min-w-[40px] rounded-full"
          />
        </div>
      </div>
    </div>
